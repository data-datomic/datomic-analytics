...
(defmethod describe-object :after ((o db-access-counter-mixin) stream)
  (print (db-access-stats o) (or stream t))
...
(defun load-ontology (uri-designator)
  (typecase uri-designator
    ...
    (node (load-ontology (node-uri uri-designator)))))
