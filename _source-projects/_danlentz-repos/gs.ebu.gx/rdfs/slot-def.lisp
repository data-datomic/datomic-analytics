...
;;   (require :rdfspackages)) ; end of eval-when
...
;;; this inverse link from these slot-definitions using slot-value function. Also note that all 
;;; slot definitions on a property is booked into the property resource objects.
...
;;;   for the class of the object to ensure class slots. In this case, the range constraint of property 
;;;   is retrieved from the property object and supplied for type option in the slot definition. 
